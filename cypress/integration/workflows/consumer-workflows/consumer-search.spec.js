...
describe("Consumer Search Tests", () => {
  ...
  it("Consumer Find Therpist - Desktop #smoke", () => {
    ...
    //Step 3
    cy.get(":nth-child(4) > :nth-child(2) > .ng-tns-c90-6 > .unselected-option")
      .scrollIntoView()
      .click();
    cy.get(":nth-child(7) > :nth-child(2) > .ng-tns-c90-6 > .unselected-option")
      .scrollIntoView()
      .click();
    cy.get(":nth-child(10) > .ng-tns-c90-6 > .unselected-option")
      .scrollIntoView()
      .click();
    cy.get(
      ":nth-child(10) > :nth-child(2) > .ng-tns-c90-6 > .unselected-option"
    )
      .scrollIntoView()
      .click();
    ...
    cy.get(
      ".col-md-12 > app-button-toggle.ng-tns-c93-8 > .btn-group > :nth-child(1)"
    ).click();

    //Click (2) Insurance Options
    cy.get(
      ":nth-child(1) > .ng-tns-c93-8 > .unselected-option > .col-10"
    ).click();
    cy.get(".pt-3 > .btn").click();
    cy.get(
      ":nth-child(2) > .ng-tns-c93-8 > .unselected-option > .col-10"
    ).click();

    //Click "Some of your matches do not take insurance. Are you willing to pay out-of-pocket if it is affordable to you?" Option
    cy.get(
      ".col-12 > app-button-toggle.ng-tns-c93-8 > .btn-group > :nth-child(1)"
    ).click();
  ...
  it("Consumer Find Therpist - Tablet #smoke", () => {
    cy.viewport("ipad-2");
    cy.get(
      ".special-zip-match > .input-group-append > .input-group-text > strong"
    ).click();
    cy.get(".form-control").clear();
    cy.get(".form-control").type("77019");
